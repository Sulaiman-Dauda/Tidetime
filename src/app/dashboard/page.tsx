  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-semibold tracking-tight text-foreground">Event Types</h1>
          ...
          {items.map((et) => {
            ...
            return (
              ...
              >
                ...
                {/* Main content — clicking navigates to editor */}
                <Link
...
function EmptyState() {
  return (
    <div className="flex flex-col items-center justify-center rounded-lg border border-dashed border-border py-20 text-center">
      ...
      <h3 className="text-sm font-medium text-foreground">Create your first event type</h3>
